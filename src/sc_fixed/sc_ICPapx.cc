...
alignxf[10] = cx*cy;
alignxf[11] = 0;
alignxf[12] = centerSource[0] - alignxf[0]*centerTarget[0] -
alignxf[4]*centerTarget[1] - alignxf[8]*centerTarget[2];
alignxf[13] = centerSource[1] - alignxf[1]*centerTarget[0] -
alignxf[5]*centerTarget[1] - alignxf[9]*centerTarget[2];
alignxf[14] = centerSource[2] - alignxf[2]*centerTarget[0] -
alignxf[6]*centerTarget[1] - alignxf[10]*centerTarget[2];
alignxf[15] = 1;
